...
const { createGeneralmaster, getAllGeneralmasters,getGeneralmasterWithQuery, getGeneralmasterWithId
    , updateGeneralmasterWithId, deleteGeneralmasterWithId } = require("../controller/generalmaster.controller");
...
router.get("/fetch-with-query", authMiddleware(['SCHOOL','USER','TEACHER','STUDENT','PARENT']), getGeneralmasterWithQuery);
